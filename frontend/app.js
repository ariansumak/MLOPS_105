...
const setStatus = (text, tone = "idle") => {
  ...
  if (tone === "ok") {
    statusBadge.style.background = "rgba(45, 156, 219, 0.18)";
    statusBadge.style.color = "#1b5f99";
  } else if (tone === "error") {
    statusBadge.style.background = "rgba(230, 59, 46, 0.18)";
    statusBadge.style.color = "#9b2a1f";
  } else {
    statusBadge.style.background = "rgba(230, 59, 46, 0.12)";
    statusBadge.style.color = "#e63b2e";
  }
};
